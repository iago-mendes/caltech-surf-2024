...
plot(
  ...
  get_test_residuals('../adm_integrals/data/isotropic_shifted/surface', '../adm_integrals/data/isotropic_shifted/surface')
)
plot(
  r'Isotropic [$(\psi^4 - 1) n^i$]',
  get_test_residuals('../adm_integrals/data/isotropic_shifted/surface-new', '../adm_integrals/data/isotropic_shifted/surface-new')
)
plot(
  r'Isotropic [$(\psi^4 - \langle \psi^4 \rangle) n^i$]',
  get_test_residuals('../adm_integrals/data/isotropic_shifted/surface-avg', '../adm_integrals/data/isotropic_shifted/surface-avg')
)
...
fig.savefig(f'shifted_CoM_components.pdf', format='pdf', bbox_inches='tight')
